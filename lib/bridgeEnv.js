...
function loadBridgeEnv(overrides = {}) {
  const env = {
    ...
    // ~50k × ~200B ≈ ~10MB; TTL covers short Traccar forward retries.
    FORWARD_RETRY_DEDUPE_TTL_MS: intEnv("FORWARD_RETRY_DEDUPE_TTL_MS", 120_000),
    FORWARD_RETRY_DEDUPE_MAX: intEnv("FORWARD_RETRY_DEDUPE_MAX", 50_000),
    ...
    TRACCAR_MODEL_NEGATIVE_CACHE_TTL_MS: intEnv("TRACCAR_MODEL_NEGATIVE_CACHE_TTL_MS", 60_000),
