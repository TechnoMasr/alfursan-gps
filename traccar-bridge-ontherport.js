...
function startSubscribersServer() {
  ...
  app.get("/health", (req, res) => {
    ...
    res.json({
      ...
      gpspoints_writer_persisted_total: writerStats.gpspoints_writer_persisted_total || 0,
      gpspoints_writer_mongo_attempted_total: writerStats.gpspoints_writer_mongo_attempted_total || 0,
      gpspoints_writer_mongo_acknowledged_total: writerStats.gpspoints_writer_mongo_acknowledged_total || 0,
      gpspoints_writer_mongo_flush_count: writerStats.gpspoints_writer_mongo_flush_count || 0,
      gpspoints_writer_batch_docs_last: writerStats.gpspoints_writer_batch_docs_last || 0,
      gpspoints_writer_batch_docs_avg: writerStats.gpspoints_writer_batch_docs_avg || 0,
      gpspoints_writer_batch_docs_max: writerStats.gpspoints_writer_batch_docs_max || 0,
      gpspoints_writer_mongo_latency_ms: writerStats.gpspoints_writer_mongo_latency_ms || 0,
      gpspoints_writer_mongo_latency_p50_ms: writerStats.gpspoints_writer_mongo_latency_p50_ms || 0,
      gpspoints_writer_mongo_latency_p95_ms: writerStats.gpspoints_writer_mongo_latency_p95_ms || 0,
      gpspoints_writer_mongo_latency_p99_ms: writerStats.gpspoints_writer_mongo_latency_p99_ms || 0,
      gpspoints_writer_retry_total: writerStats.gpspoints_writer_retry_total || 0,
      gpspoints_writer_persist_failures: writerStats.gpspoints_writer_persist_failures || 0,
      gpspoints_writer_quarantined_total: writerStats.gpspoints_writer_quarantined_total || 0,
      gpspoints_writer_backlog_docs: writerStats.gpspoints_writer_backlog_docs || 0,
